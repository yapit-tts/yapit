-- Add token sum columns to continuous aggregates for long-range cost tracking.
--
...
--
-- Apply: ssh prod 'docker exec $(docker ps -qf name=metrics-db) psql -U metrics -d metrics' < docker/metrics-migrations/002_add_token_sums_to_aggregates.sql

-- ============================================================================
-- Hourly aggregates
-- ============================================================================

-- Remove refresh + retention policies before dropping
