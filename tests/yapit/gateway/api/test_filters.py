...
@pytest.mark.asyncio
async def test_validate_regex_ok(client):
    body = {
        "filter_config": {
...
# Add test back once filter system is thought through and reimplemented
# # end-to-end filter flow
#
#
# @pytest.mark.asyncio
# async def test_apply_filters_and_blocks(client):
...
#
#
# async def _poll_status(client, document_id: str, expect: str, timeout: float = 15.0) -> None:
#     import asyncio
#
#     t0 = time.time()
