...
class Redis:
    ...
    async def brpop(self, keys: list[KeyT], timeout: int = 0) -> tuple[bytes, bytes] | None: ...
    ...
    # Hash
    async def hset(self, name: KeyT, key: str, value: EncodableT) -> int: ...
    async def hget(self, name: KeyT, key: str) -> bytes | None: ...
    async def hdel(self, name: KeyT, *keys: str) -> int: ...
