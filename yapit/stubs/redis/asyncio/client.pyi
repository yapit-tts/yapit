...
class Redis:
    ...
    async def mget(self, keys: KeyT | list[KeyT], *args: KeyT) -> list[bytes | None]: ...
    ...
    # Stream
    async def xadd(self, name: KeyT, fields: dict[str | bytes, EncodableT], id: str = "*", maxlen: int | None = None, approximate: bool = True, nomkstream: bool = False, minid: str | None = None, limit: int | None = None) -> bytes: ...
    async def xreadgroup(self, groupname: str, consumername: str, streams: dict[str | bytes, str | bytes], count: int | None = None, block: int | None = None, noack: bool = False) -> list[Any]: ...
